...
### 1. Expand statistics and permanent unlock progress

Lifetime Lines of Code is already tracked, persisted, and displayed. Continue with
additional cumulative values that are not reduced when the player spends resources,
adding them one at a time through the model, save data, ViewModel, and Statistics
view.
...
These statistics can support permanent content reveals, achievements, and eventually
prestige.

### 2. Add the first achievements
